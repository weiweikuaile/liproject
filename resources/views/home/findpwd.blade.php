...
<html>
	<head>
		...
		<title></title>
		<link rel="stylesheet" href="dist/css/findpwd/ucenter.css">
		<link rel="stylesheet" href="dist/css/findpwd/common.css">
		...
		<div id="main">
			...
			<div id="mibaowenti">
				...
				<form action="/doyanemail" method="post">
					...
					<button id="email" type="submit" value="提交" style="width:70px">提交</button>
				</form>
			...
			<script type="text/javascript">
        		$('#email').click(function(){
					...
					//发送ajax post请求
		        	$.post('{{url("/doyanemail")}}',{verify:email},function(data){
		            	//console.log(data);
		                /*if(data == "1"){
		                    alert('邮箱名正确');
		                }else{
