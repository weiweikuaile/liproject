...
<head>
    ...
    <title>LAMP-148 -- 后台@yield('title')</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">LAMP-148 -- 官网</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <!-- 用户管理 -->
                        <li>
                            <a href="index.html"><i class="fa fa-user fa-fw"></i>用户管理<span class="fa arrow"></span></a>
                        ...
                        <!-- 商品管理 -->
                         <li>
                            <a href="index.html"><i class="fa fa-shopping-cart fa-fw"></i>商品管理<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="flot.html">商品添加</a>
                                </li>
                                <li>
